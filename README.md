...
> **참고**: 아래는 추천 스크린샷 예시입니다. 실제 프로젝트 화면으로 교체해주세요.

1.  **기본 기능**: 스크롤바에 질문 마커들이 생성된 모습
    ![기본 기능](images/screenshot-main.png)

2.  **질문 미리보기**: 마커에 마우스를 올렸을 때 질문 내용이 보이는 모습
    ![질문 미리보기](images/screenshot-hover.png)

3.  **즐겨찾기**: 마커를 우클릭하여 노란색 즐겨찾기로 등록한 모습
    ![즐겨찾기](images/screenshot-favorite.png)

4.  **팝업 화면**: 확장 프로그램 팝업에서 질문 목록을 관리하는 모습
    ![팝업 화면](images/screenshot-popup.png)
